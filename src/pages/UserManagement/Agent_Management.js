...
const OfferManagement = ({ history, setUsers, userData, }) => {
    ...
    const getOffers = async () => {
        try {
            const { data } = await axios.get("/admin/get-users/AGENT");
                ...
                <DashboardContainer>
                    <DashboardWrapper>
                        <DashboardHeading>
                            <MenuAndBack>
                                <DashHeading>
                                    {menuState.isOfferVoucher ? "Agent Management" : ""}
                                    {(menuState.isAddOffer) ?
                                        (offerValues._id) ? `Edit Details` : `Add Details` : ""
                                    }
                                </DashHeading>
                            </MenuAndBack>
                                        ...
                                        <Table stickyHeader>
                                            <TableHead>
                                                <TableRow>
                                                    ...
                                                    <TableCell className={classes.tablePadding}>Gender</TableCell>
                                                    ...
                                                    <TableCell className={classes.tablePadding}><TableSortLabel
                                                        ...
                                                        <TableCell className={classes.tablePadding}>Unit Id</TableCell>
                                                ...
                                                {recordsAfterPagingAndSorting().map((category, index) => (
                                                    <TableRow key={category._id}>
                                                        ...
                                                        <TableCell className={classes.textMiddle}>
                                                            <div>
                                                                {get(category, 'first_name', '') + " " + get(category, 'last_name', '') }
                                                            </div>
                                                        </TableCell>
                                                        <TableCell className={classes.textMiddle}>
                                                            <div>
                                                        ...
                                                        <TableCell className={classes.textMiddle}>
                                                            <div>
                                                        {get(category, 'unit_id', '')}
                                                            </div>
                                                        </TableCell>
                                                        <TableCell className={classes.textMiddle}>
                                                        {category?.is_approve === "1" && 
                                                            <ApproveButton>Approve</ApproveButton>
                                                        }

                                                        {category?.is_approve === "2" && 
                                                            <PendingButton>Pending</PendingButton>
                                                        }

                                                        {category?.is_approve === "3" && 
                                                        ...
                                                        variant="outlined"
                                                            ...
                                                            onClick={() => {
                                                            history.push({
                                                                pathname: `/adminPanel/agent/${category.id}`,
                                                            });
                                                        }}                                      
                                                        >
                                                            <VisibilityIcon
                                                        ...
                                                        <Button 
                                                            ...
                                                            >
                                                            <BlockIcon
                                                            style={{color:(category.is_blocked === true ? 'red' : 'green')}}
                                                            />
                                                        </Button>
                                                            </Tooltip>
                                                            </div>
