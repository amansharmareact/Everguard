...
const OfferManagement = ({ history, setUsers, userData }) => {
  ...
  const checkdata = [
    ...
    {
      id: "10",
      name: "Rating and Review Management",
    },
    {
      id: "11",
    ...
    {
      id: "12",
      name: "Returned Order Management",
    },
    {
      id: "13",
  ...
  const matchBox = (e) => {
    if (e === peopleInfo[0]) {
      // console.log("success");
      return true;
    } else if (e === peopleInfo[1]) {
      // console.log("success");
      return true;
    } else if (e === peopleInfo[2]) {
      // console.log("success");
      return true;
    } else if (e === peopleInfo[3]) {
      // console.log("success");
      return true;
    } else if (e === peopleInfo[4]) {
      // console.log("success");
      return true;
    } else if (e === peopleInfo[5]) {
      // console.log("success");
      return true;
    }
  };
  ...
  console.log("peopleInfo", peopleInfo.map((val) => val.id).slice(1));
