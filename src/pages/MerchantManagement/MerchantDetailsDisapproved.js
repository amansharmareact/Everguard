...
const OfferManagement = ({ history, setUsers, userData }) => {
  ...
  const getMerchantList = async () => {
    try {
      const { data } = await axios.get(`/admin/listmerchants?id=${merchant_id}&approvalStatus=rejected`);
            ...
            <DashboardHeading>
              <MenuAndBack>
                <ArrowBackIosIcon
                  ...
                  onClick={() => history.push({ pathname: "/adminPanel/merchant_disapprove", state: state })}
                />
