...
const [imageZoomed,setImageZoomed]=useState("")
  ...
  const getMerchantList = async () => {
    try {
      const { data } = await axios.get(`/admin/listmerchants?id=${merchant_id}&approvalStatus=pending`);
  ...
  const approveMerchant = async (id) => {
    try {
      ...
      // getMerchantList();
      history.push({
        pathname: "/adminPanel/merchant_approve",
      });
    } catch (error) {
      console.log(error);
    }
  ...
  const handleDisapprove = async (values) => {
    ...
    let RejectionReasons = [
      ...
      values.shopInformationCheck === true
        ...
        : undefined,
        values.shopTimingCheck === true
        ? {
            key: "shop.timing",
            // color: "optional",
            // value: "Aditya112",
            reason: values.shopTiming,
          }
        : undefined,
    ...
    let ImagesArray = [
      ...
      //   ? 
      tableData?.shop?.images[0]?
        {
            imageurl: tableData?.shop?.images[0],

            // color: "optional",
            // value: "Aditya112",
            reason: values.Image1===""?"No Reason":values.Image1,
          }
        : undefined
        ,
      // values.Image2Check === true
      tableData?.shop?.images[1]?
      //   ? 
        {
            imageurl: tableData?.shop?.images[1],
            // color: "optional",
            // value: "Aditya112",
            reason: values.Image2===""?"No Reason":values.Image2,
          }
        : undefined
        ,
      // values.Image3Check === true
      //   ? 
      tableData?.shop?.images[2]?
        {
            imageurl: tableData?.shop?.images[2],
            // color: "optional",
            // value: "Aditya112",
            reason: values.Image3===""?"No Reason":values.Image3,
          }
        : undefined
        ,
      // values.Image4Check === true
      //   ?
      tableData?.shop?.images[3]?
         {
            imageurl: tableData?.shop?.images[3],
            // color: "optional",
            // value: "Aditya112",
            reason: values.Image4===""?"No Reason":values.Image4,
          }
        : undefined
        ,
      // values.Image5Check === true
      //   ? 
      tableData?.shop?.images[4]?
        {
            imageurl: tableData?.shop?.images[4],
            // color: "optional",
            // value: "Aditya112",
            reason: values.Image5===""?"No Reason":values.Image5,
          }
        : undefined
        ,
      // values.Image6Check === true
      //   ? 
      tableData?.shop?.images[5]?
        {
            imageurl: tableData?.shop?.images[5],
            // color: "optional",
            // value: "Aditya112",
            reason: values.Image6===""?"No Reason":values.Image6,
          }
        : undefined
        ,
      // values.Image7Check === true
      //   ? 
      tableData?.shop?.images[6]?
        {
            imageurl: tableData?.shop?.images[6],
            // color: "optional",
            // value: "Aditya112",
            reason: values.Image7===""?"No Reason":values.Image7,
          }
        : undefined
        ,
      // values.Image8Check === true
      //   ? 
      tableData?.shop?.images[7]?
        {
            imageurl: tableData?.shop?.images[7],
            // color: "optional",
            // value: "Aditya112",
            reason: values.Image8===""?"No Reason":values.Image8,
          }
    ...
    let ImagesFinalArray = ImagesArray.filter(Boolean);
    const submitValues = {
      _id: tableData._id,
      isBlocked: false,
      approvalStatus: "rejected",
      rejectedReason: submitData,
      rejectedImages: ImagesFinalArray,
    };
    ...
    if (
      ...
      try {
        ...
        setOpenModal(false);
        history.push({
          pathname: "/adminPanel/merchant_disapprove",
        });
      } catch (error) {
        console.log(error);
      }
            ...
            <DashboardHeading>
              <MenuAndBack>
                <ArrowBackIosIcon
                  ...
                  onClick={() => history.push({ pathname: "/adminPanel/merchant_pending", state: state })}
                />
                  ...
                  <InnerCardDivision>
                    <CardLeft>
                      <Card1>
                        ...
                        <div style={{ display: "flex", gap: "1rem", margin: "1rem 0rem",width:"100%",flexWrap:"wrap" }}>
                          <Button
                            // variant="outlined"
                            aria-label="add"
                          ...
                          <Button
                            ...
                            onClick={() => {
                              setOpenModal(true);
                              // disapproveMerchant(tableData._id);
                            }}
                          >
                            Disapprove
                          </Button>
                ...
                <Form style={{ width: "100%" }}>
                  <div className="container">
                          ...
                          <Field name="website">
                            {({ field }) => (
                              <Input
                                ...
                                error={
                                  formikBag.touched.website && formikBag.errors.website
                                    ? formikBag.errors.website
                                    : null
                                }
                                placeholder={"Reason"}
                                className="form-control"
                    ...
                    <div className="row my-3">
                      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                        {" "}
                        <Field name="shopTimingCheck">
                          {({ field }) => (
                            <div style={{ display: "flex", alignItems: "center" , alignItems: "center", gap: "0.5rem"}}>
                              <Input
                                {...field}
                                type="checkbox"
                                onChange={(e) => {
                                  formikBag.setFieldValue("shopTimingCheck", e.target.checked);
                                }}
                                error={
                                  formikBag.touched.websiteCheck && formikBag.errors.websiteCheck
                                    ? formikBag.errors.websiteCheck
                        ...
                        <div style={{ display: "flex", flexDirection: "column" }}>
                          <Field name="shopTiming">
                            {({ field }) => (
                              <Input
                                {...field}
                                type="text"
                                onChange={(e) => {
                                  formikBag.setFieldValue("shopTiming", e.target.value);
                                }}
                                error={
                                  formikBag.touched.shopTiming && formikBag.errors.shopTiming
                                    ? formikBag.errors.shopTiming
                                    : null
                                }
                                placeholder={"Reason"}
                                className="form-control"
