...
const OfferManagement = ({ history, setUsers, userData, }) => {
    ...
    const getPropertyList = async () => {
        try {
            const { data } = await axios.get("/admin/all-property-list");
                                ...
                                <TableHead>
                                    <TableRow>
                                        ...
                                        <TableCell className={classes.tablePadding}>
                                            <TableSortLabel
                                               active={true}
                                                direction={orderBy === "property_unit_id" ? order : "asc"}
                                                onClick={() => {
                                                    handleSortRequest("property_unit_id");
                                                }}
                                            >
                                                Property ID
                                            </TableSortLabel>
                                       ...
                                       <TableCell className={classes.tablePadding}>
                                        <TableSortLabel
                                                active={true}
                                                    ...
                                                    onClick={() => {
                                                        handleSortRequest("updatedAt");
                                                    }}
                                                >
                                                    Property Location
                                        </TableSortLabel>
                                        </TableCell>
                                            <TableCell className={classes.tablePadding}>Posted By</TableCell>
                                            <TableCell className={classes.tablePadding}>Actions</TableCell>
                                    </TableRow>
                                </TableHead>
                                <TableBody>
                                    {recordsAfterPagingAndSorting().reverse().map((category, index) => (
                                        <TableRow key={category._id}>
                                            ...
                                            <TableCell className={classes.textMiddle}>
                                                <div>
                                                {category?.address?.state}{","} {category?.address?.country}
                                                </div>
                                            </TableCell>
                                            <TableCell className={classes.textMiddle}>
                                                <div>
                                                <div style={{marginRight : '1rem', fontWeight: '600'}}>{category?.user?.role}</div>
                                                </div>
                                            </TableCell>
                                           ...
                                           <div style={{marginRight : '1rem'}}>
                                                    ...
                                                    <Button 
                                                     style={{background: "#e85f53", color: 'white'}}
                                                variant="outlined"
                                                    aria-label="add"
                                                    className={classes.iconMargin}
                                                    onClick={() => {
                                                        history.push(`/adminPanel/agent-approve/${category?.user?._id}?agent=true`)
                                                }}                              
                                                >
                                                Agent Details
                                                    </Button>
                                           ...
                                           <div>
                                                    <Button 
                                                     style={{background: "#5ca764", color: 'white'}}
                                                variant="outlined"
                                                    aria-label="add"
                                                    className={classes.iconMargin}
                                                    onClick={() => {
                                                        history.push(`/adminPanel/property/status/${category?._id}`)
                                                }}                                      
                                                >
                                                Property Status
                                                    </Button>
